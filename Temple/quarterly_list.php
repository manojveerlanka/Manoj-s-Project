...
$sql = "SELECT name, first_name, address, phone, alt_phone, email, quarterly_start_date, quarterly_end_date FROM subscribers WHERE 
            (('$today' BETWEEN quarterly_start_date AND quarterly_end_date) AND quarterly = 1)
            OR permanent_subscriber = 1";
$result = $conn->query($sql);

echo "<h2>Quarterly Subscribers - Address List</h2>";
